...
class Ebizmarts_PosShell_Pos extends Mage_Shell_Abstract {
    ...
    private function processResource($resource) {
        ...
        if($this->_startPage === 2) {
            ...
            if($this->_profiler) $this->profilerLog($resource, $pageNumber);
    ...
    private function profilerStart() {
        ...
        $this->profilerLogger = Mage::helper('bakerloo_restful');
        $this->profilerLogger->startprofiler();
    }
    ...
    private function profilerLog($resource, $pageNumber) {
        ...
        $this->profilerLogger->logprofiler($this->getStoreId(), $resource, 'page_'.$pageNumber);
    }
