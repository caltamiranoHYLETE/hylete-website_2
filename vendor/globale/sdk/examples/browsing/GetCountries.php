...
<br /><br />
<h3><u>GetCountries Example:</u></h3>

<br />Request: <br />
$SDK->Browsing()->OnPageLoad();<br /><br />
1) $SDK->Browsing()->GetCountries();<br /><br />
2) $SDK->Browsing()->IsCountryOperatedByGlobale('AG'));<br /><br />
3) $SDK->Browsing()->IsUserSupportedByGlobale());<br /><br />

<hr /><br />Response: <br />
<pre>
    <?php
    $SDK->Browsing()->OnPageLoad();
    var_dump($SDK->Browsing()->GetCountries());
    ?>
    <hr />
    <?php
    var_dump($SDK->Browsing()->GetCountries());
    ?><hr />
    <?php
    var_dump($SDK->Browsing()->IsCountryOperatedByGlobale('AG'));
    ?><hr />
    <?php
    var_dump($SDK->Browsing()->IsUserSupportedByGlobale());
    ?><hr />
