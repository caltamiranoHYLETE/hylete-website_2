...
<br /><br />
<h3><u>IsCountryOperatedByGlobale Example:</u></h3>

<br />Request: <br />
$SDK::Browsing()->Initialize(1.1, 'EUR', 'IT', 'en-GB');<br /><br />
$SDK::Browsing()->IsCountryOperatedByGlobale('USD')<br /><br />

<hr /><br />Response: <br />
<pre>
    <?php
    $SDK::Browsing()->Initialize(1.1, 'EUR', 'IT', 'en-GB');
    var_dump($SDK::Browsing()->IsCountryOperatedByGlobale('USD'));
    ?>
</pre>
