...
<br /><br />
<h3><u>GetCustomerInformation Example:</u></h3>

<br />Request: <br />
$SDK::Browsing()->Initialize(1.1, 'EUR', 'IT', 'en-GB');<br />
$SDK::Browsing()->GetCustomerInformation();

<hr /><br />Response: <br />
<pre>
    <?php
    $SDK::Browsing()->Initialize(1.1, 'EUR', 'IT', 'en-GB');
    var_dump($SDK::Browsing()->GetCustomerInformation());
    ?>
</pre>
