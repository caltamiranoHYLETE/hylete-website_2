...
SUPEE-11219_EE_11420 | EE_1.14.2.0 | v1 | 9e8933ac3bdd73b182c5215d39de54c50e41f158 | Mon Oct 7 16:32:38 2019 +0000 | e09dc9bee7b6fe338c2d9f4434f701996e5a7b8c..HEAD
...
index 3a61ace7a37..45a474db7db 100644
...
+        return $this->_getUrlCustomParams($product);
     ...
     /**
@@ -115,12 +111,7 @@ class Mage_Catalog_Helper_Product_Compare extends Mage_Core_Helper_Url
      */
...
+        return $this->getAddUrlCustom($product);
     ...
     /**
@@ -131,15 +122,7 @@ class Mage_Catalog_Helper_Product_Compare extends Mage_Core_Helper_Url
      */
     public function getAddToWishlistUrl($product)
     {
...
+        return $this->getAddToWishlistUrlCustom($product);
     ...
     /**
@@ -150,14 +133,7 @@ class Mage_Catalog_Helper_Product_Compare extends Mage_Core_Helper_Url
      */
...
+        return $this->getAddToCartUrlCustom($product);
     ...
     /**
@@ -319,4 +295,74 @@ class Mage_Catalog_Helper_Product_Compare extends Mage_Core_Helper_Url
         $this->_customerId = $id;
         return $this;
     }
+
...
index c24278700a8..c8e0aed94f0 100644
...
index d5847bbf6bf..76cd6a5837c 100644
...
index 1005808a84b..e7117f76fc6 100644
