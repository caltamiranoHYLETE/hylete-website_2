...
class MageWorx_SeoMarkup_Helper_Config extends Mage_Core_Helper_Abstract
{
    ...
    const XML_PATH_WEBSITE_RICHSNIPPET_MAIN_ONLY    = 'mageworx_seo/richsnippets/website_rs_main_only';
    ...
    const XML_PATH_WEBSITE_OPENGRAPH_APP_ID         = 'mageworx_seo/richsnippets/website_og_app_id';
    ...
    const XML_PATH_PAGE_GA_ENABLED                  = 'mageworx_seo/richsnippets/enable_page_ga';
    const XML_PATH_PAGE_GA_CSS_SELECTOR             = 'mageworx_seo/richsnippets/page_ga_css_selector';
    ...
    const XML_PATH_CATEGORY_GA_ENABLED              = 'mageworx_seo/richsnippets/enable_category_ga';
    const XML_PATH_CATEGORY_GA_CSS_SELECTOR         = 'mageworx_seo/richsnippets/category_ga_css_selector';
    ...
    const XML_PATH_PRODUCT_GA_ENABLED               = 'mageworx_seo/richsnippets/enable_product_ga';
    const XML_PATH_PRODUCT_GA_CSS_SELECTOR          = 'mageworx_seo/richsnippets/product_ga_css_selector';
    ...
    {
        return Mage::getStoreConfig(self::XML_PATH_WEBSITE_OPENGRAPH_APP_ID);
    }
    ...
    public function isWebsiteRichsnippetAddOnlyForMainPage()
    {
        return Mage::getStoreConfigFlag(self::XML_PATH_WEBSITE_RICHSNIPPET_MAIN_ONLY);
    }
    ...
    {
        $result = (MageWorx_SeoMarkup_Model_System_Config_Source_BreadcrumbsMethod::RICHSNIPPET_INJECTION_MICRODATA ==
        ...
        return $this->isSimpleHtmlDomAvailable();
    }

    public function isBreadcrumbsJsonLdMethod()
    {
        $result = (MageWorx_SeoMarkup_Model_System_Config_Source_BreadcrumbsMethod::RICHSNIPPET_JSON_LD ==
            Mage::getStoreConfig(self::XML_PATH_BREADCRUMBS_METHOD));
        ...
        if (!$this->isSimpleHtmlDomAvailable()) {
            return true;
        }
    ...
    public function isPageGaEnabled()
    {
        return (bool) Mage::getStoreConfigFlag(self::XML_PATH_PAGE_GA_ENABLED);
    }

    public function getPageGaCssSelectors()
    {
        return trim(Mage::getStoreConfig(self::XML_PATH_PAGE_GA_CSS_SELECTOR));
    }
    ...
    public function isCategoryGaEnabled()
    {
        return (bool) Mage::getStoreConfigFlag(self::XML_PATH_CATEGORY_GA_ENABLED);
    }

    public function getCategoryGaCssSelectors()
    {
        return trim(Mage::getStoreConfig(self::XML_PATH_CATEGORY_GA_CSS_SELECTOR));
    }
    ...
    public function isProductGaEnabled()
    {
        return (bool) Mage::getStoreConfigFlag(self::XML_PATH_PRODUCT_GA_ENABLED);
    }

    public function getProductGaCssSelectors()
    {
        return trim(Mage::getStoreConfig(self::XML_PATH_PRODUCT_GA_CSS_SELECTOR));
    }
    ...
    public function isSimpleHtmlDomAvailable()
    {
        try {
    ...
    {
        $result = (MageWorx_SeoMarkup_Model_System_Config_Source_ProductMethod::RICHSNIPPET_INJECTION_MICRODATA ==
    ...
    {
        $result = (MageWorx_SeoMarkup_Model_System_Config_Source_ProductMethod::RICHSNIPPET_JSON_LD ==
            Mage::getStoreConfig(self::XML_PATH_PRODUCT_METHOD));
    ...
    public function isAddReviews()
    {
        return trim(Mage::getStoreConfigFlag(self::XML_PATH_ADD_REVIEWS));
    }
