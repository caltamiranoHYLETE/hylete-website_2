...
class Vaimo_Cms_Helper_Cache_Layer extends Vaimo_Cms_Helper_Abstract
{
    protected $_instanceStorage = array();

    public function getData($cacheKey, $flag, $tags, closure $callable)
    {
        ...
        if (!$cache->test($cacheKey, $flag)) {
            ...
            $cache->saveSerialized($cacheKey, $items, $tags);

            $this->_instanceStorage[$cacheKey] = $items;
