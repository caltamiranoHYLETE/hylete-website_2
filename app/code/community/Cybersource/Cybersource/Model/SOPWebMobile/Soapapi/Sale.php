...
class Cybersource_Cybersource_Model_SOPWebMobile_Soapapi_Sale extends Cybersource_Cybersource_Model_SOPWebMobile_Soapapi_Abstract
{
    /**
     * @param Mage_Sales_Model_Order_Payment $payment
     * @param stdClass $token
     * @param bool $isMit
     * @return Cybersource_Cybersource_Model_SOPWebMobile_Soapapi_Sale
	...
	public function process($payment, $token, $isMit = false)
	{
        ...
        if (! in_array($result->reasonCode, $this->successCodeList)) {
            throw new Exception('Sale transaction failed with reason code: ' . $result->reasonCode);
        }
