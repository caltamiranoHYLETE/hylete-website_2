...
class Cminds_Coupon_Model_Observer
{
    public function beforeCouponApply($observer){

        $result = $this->checkCoupon($observer);
        ...
        $this->goBack($observer);
    }

    public function beforeMagestoreCouponApply($observer){
    ...
    private function goBack($observer){
