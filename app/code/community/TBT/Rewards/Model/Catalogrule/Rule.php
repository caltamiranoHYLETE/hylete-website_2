...
class TBT_Rewards_Model_Catalogrule_Rule extends Mage_CatalogRule_Model_Rule implements TBT_Rewards_Model_Migration_Importable {
	...
	protected function _beforeSave() {
        ...
        {
            Mage::helper('rewards/tracking')->sendRuleData('catalog', $this);
	 ...
	 * TODO Sweet Tooth: any way to optimize this array_search? perhaps a map?
     ...
     * @return self
     */
    public function applyAllRedemptionRules($productId = null)
    {
        //$this->getResourceCollection()->walk(array($this->_getResource(), 'updateRuleProductData'));
        $this->_getResource()->applyAllRedemptionRulesForDateRange($productId);
    ...
    public function unserializeActions()
    {
        ...
        if (!empty($actions)) {
            $actions = $serializerHelper->unserializeData($actions);
