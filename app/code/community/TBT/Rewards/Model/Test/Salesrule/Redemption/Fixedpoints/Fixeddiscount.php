<?php
class TBT_Rewards_Model_Test_Salesrule_Redemption_Fixedpoints_Fixeddiscount extends TBT_Rewards_Model_Test_Salesrule_Redemption {

    public function runSuite() {
    	$this->o("<BR />====BEGIN Salesrule_Redemption_Fixedpoints_Fixeddiscount test suite <BR />");
    	$this->prepareRules();
    	...
    	$this->o("<BR />&gt; 2. Fixed discount $50 applied to the cart: <BR />\n");
