...
class TBT_Rewards_Model_Special_Action extends Varien_Object
{
    ...
    /*
     * @deprecated Referencing these codes from this class is deprecated. 
     * Use the individual module classes instead.	
     */
    ...
    /* Rule action types */
    const ACTION_TYPE_CUSTOMER_GROUP = 'customergroup';
    const ACTION_TYPE_GRANT_POINTS = 'grantpoints';
    ...
    {
        return Mage::getConfig ()->getNode ( 'rewards/specialrule/action' )->children ();
    }
