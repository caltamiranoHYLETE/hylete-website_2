 ...
 */
class TBT_Rewards_Firecheckout_RedeemController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    public function reviewAction()
    {
        ...
        if (!$block) {
            $html = Mage::helper('rewards')->__('The order summary cannot be loaded. Please contact support if you need any assistance.');
        } else {
            $html = $block->toHtml();
        }
