...
class TBT_Rewards_Helper_Currency extends Mage_Core_Helper_Abstract {
    ...
    /**
     * Will return 1 (int) as the default currency ID.
     * Sweet Tooth does not support multiple currinces out of the box.
     * For extendability purposes, some models accept a Currency ID however.
     *
     * @return number
     */
    ...
    /**
     * Fetch the currency caption (label)
     * @param int $currency_id
     * @return string
     */
    ...
    /**
     * Same as getCurrencyCaption() but adds "Points"
     * @param int $currencyId
     * @return string
     */
    public function getFullCurrencyCaption($currencyId)
    {
        return $this->getCurrencyCaption($currencyId) . ' ' . $this->__('Points');
    }
    
    /**
     * getFullCurrencyCaption for the default currency ID
     * @return string
     */
    public function getDefaultFullCurrencyCaption()
    {
        $currencyId = $this->getDefaultCurrencyId();
        return $this->getFullCurrencyCaption($currencyId);
    }
