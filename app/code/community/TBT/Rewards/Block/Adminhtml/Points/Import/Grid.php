...
class TBT_Rewards_Block_Adminhtml_Points_Import_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('points_import_grid');
    ...
    protected function _prepareCollection()
    {
    	$importers = TBT_Rewards_Model_Importer::getImportersCollection()
            ->addFieldToFilter('type', 'rewards/points_importer');
    ...
    protected function _prepareColumns()
    {
    	...
    	$this->addColumn('status', array(
            ...
            'index'    => 'status',
            'renderer' => 'TBT_Rewards_Block_Adminhtml_Points_Import_Grid_Renderer_Status',
    	));
