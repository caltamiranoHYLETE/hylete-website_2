...
class TBT_Rewards_Block_Adminhtml_Sales_Order_View_Tab_Points extends Mage_Adminhtml_Block_Widget_Grid implements Mage_Adminhtml_Block_Widget_Tab_Interface {
	...
	protected function _prepareColumns() {
		...
		//		));
		//		
		//		$url = $this->getUrl('adminhtml/manage_transfer/edit', array( 
		//    					'module' => 'adminhtml', 
		...
		$this->addColumn ( 'action', array ('header' => Mage::helper ( 'rewards' )->__ ( 'Action' ), 'width' => '50px', 'type' => 'action', 'getter' => 'getId', 'actions' => array (array ('caption' => Mage::helper ( 'rewards' )->__ ( 'View' ), //'url'       => array('base'=> '/manage_transfer/edit'),
//						'url'       => array('base'=> '/manage_transfer/edit',
		//												'module' => 'adminhtml', 
		//    											'controller' => 'sales_order', 
		//    											'action' => 'view'
		//									),
		'url' => array ('base' => 'adminhtml/manage_transfer/edit/' . 'module/adminhtml/controller/sales_order/action/view/' . 'order_id/' . $this->getOrderId () ), 'field' => 'id' ) ), 'filter' => false, 'sortable' => false, 'index' => 'stores', 'is_system' => true ) );
