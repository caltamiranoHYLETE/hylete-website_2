...
class TBT_Rewards_Block_Manage_Currency_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
	...
	protected function _prepareForm() {
		...
		Mage::getSingleton('rewards/wikihints')->addWikiHint($fieldset, "article/353-setting-up-a-points-currency-image-in-magento", "Points Currency Section" );
		...
		$fieldset->addField ( 'caption', 'text', array ('name' => 'caption',
