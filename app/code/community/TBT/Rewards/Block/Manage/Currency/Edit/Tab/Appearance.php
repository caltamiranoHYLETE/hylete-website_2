...
class TBT_Rewards_Block_Manage_Currency_Edit_Tab_Appearance extends Mage_Adminhtml_Block_Widget_Form {
	...
	protected function _prepareForm() {
		...
		Mage::getSingleton('rewards/wikihints')->addWikiHint($fieldset, "article/353-setting-up-a-points-currency-image-in-magento", "Points Currency Appearance" );
		...
		Mage::getSingleton('rewards/wikihints')->addWikiHint($image_field, "article/297-points-currency-section-image-path", "Points Currency Section - Image Path" );
