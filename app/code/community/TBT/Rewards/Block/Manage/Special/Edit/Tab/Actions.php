...
class TBT_Rewards_Block_Manage_Special_Edit_Tab_Actions extends Mage_Adminhtml_Block_Widget_Form {
	protected function _prepareForm() {
	    ...
	    Mage::getSingleton('rewards/wikihints')->addWikiHint($fieldset, "article/357-customer-behavior-rule-actions", "Customer Behavior Rule - Actions" );
	    ...
	    Mage::getSingleton('rewards/wikihints')->addWikiHint($isOnholdEnabledField, "article/383-managing-point-transfers", "Customer Behavior Rule - Actions - Transfer On-hold Time" );
