...
//		var_dump(get_class(Mage::getModel('rewards/customer')->load(Mage::registry('current_customer'))->getTransfers())); die();
	...
	protected function _prepareLayout() {
		$url = $this->getUrl ( 'adminhtml/manage_transfer/new', array ('module' => 'adminhtml', 'controller' => 'customer', 'action' => 'edit', 'customer_id' => $this->getCustomer ()->getId () ) );
	...
	protected function _prepareColumns() {
		...
		//		));
		//		
		$this->addColumn ( 'action', array ('header' => Mage::helper ( 'rewards' )->__ ( 'Action' ), 'width' => '50px', 'type' => 'action', 'getter' => 'getId', 'actions' => array (array ('caption' => Mage::helper ( 'rewards' )->__ ( 'Edit' ), //						'url'       => array('base'=> '/manage_transfer/edit'),
'url' => array ('base' => 'adminhtml/manage_transfer/edit/' . 'module/adminhtml/controller/customer/action/edit/' . 'customer_id/' . $this->getCustomer ()->getId () ), 'field' => 'id' ) ), 'filter' => false, 'sortable' => false, 'index' => 'stores', 'is_system' => true ) );
	...
	public function getGridUrl() {
		return $this->getUrl ( 'adminhtml/manage_customer_edit/transfersGrid', array ('customer_id' => $this->getCustomerId (), '_current' => true ) ); //array('id' => $this->_getTransfer()->getId()
	}
