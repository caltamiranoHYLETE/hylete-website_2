...
class TBT_Rewards_Block_Manage_Promo_Quote_Edit_Tab_Main extends TBT_Rewards_Block_Admin_Widget_Form_Abstract {
	...
	protected function _prepareForm() {
		...
		if (Mage::helper ( 'rewards' )->isBaseMageVersionAtLeast ( '1.4.1.0' )) {
		    ...
		    Mage::getSingleton('rewards/wikihints')->addWikiHint($couponTypeFiled, "article/293-coupons", "Shopping Cart Rule - Coupons" );
		    ...
		    Mage::getSingleton('rewards/wikihints')->addWikiHint($couponCodeFiled, "article/293-coupons", "Shopping Cart Rule - Coupons" );
