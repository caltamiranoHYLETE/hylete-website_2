...
class TBT_Rewards_Block_Manage_Promo_Quote_Edit_Tab_Labels extends TBT_Rewards_Block_Manage_Promo_Quote_Edit_Tab_Abstract {
	...
	protected function _prepareForm() {
		...
		Mage::getSingleton('rewards/wikihints')->addWikiHint($fieldset, "article/289-rule-labels", "Shopping Cart Spending Rule: Default Label" );
		...
		Mage::getSingleton('rewards/wikihints')->addWikiHint($fieldset, "article/289-rule-labels", "Shopping Cart Spending Rule: Store View Specific Labels" );
