...
class TBT_Rewards_Block_Manage_Promo_Catalog_Edit_Tab_Actions extends Mage_Adminhtml_Block_Widget_Form {
	...
	protected function _prepareForm() {
		...
		if ($this->_isDistributionType ()) {
		    ...
		    Mage::getSingleton('rewards/wikihints')->addWikiHint($fieldset, "article/426-set-up-a-catalog-earning-rule", "Catalog Earning Rule - Actions" );
		    ...
		    Mage::getSingleton('rewards/wikihints')->addWikiHint($points_max_qty_field, "article/300-maximum-total-of-points-to-transfer", "Catalog Points Earning Rule: Maximum Total of Points To Transfer" );
			...
			Mage::getSingleton('rewards/wikihints')->addWikiHint($fieldset, "article/399-setting-up-a-catalog-spending-rule", "Catalog Points Spending Rule - Actions - Discount Amount" );
			...
			Mage::getSingleton('rewards/wikihints')->addWikiHint($element, "article/400-stop-further-rule-processing", "Stop further rules processing");
			...
			Mage::getSingleton('rewards/wikihints')->addWikiHint($points_uses_per_product_field, "article/308-catalog-points-spending-rule-actions-uses-allowed-per-product", "Catalog Points Spending Rule - Actions - Uses Allowed Per Product" );
