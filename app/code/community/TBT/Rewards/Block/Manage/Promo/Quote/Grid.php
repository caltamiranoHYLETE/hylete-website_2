...
class TBT_Rewards_Block_Manage_Promo_Quote_Grid extends Mage_Adminhtml_Block_Widget_Grid {
	...
	protected function _prepareColumns() {
		...
		$this->addColumn ( 'is_active', array ('header' => Mage::helper ( 'salesrule' )->__ ( 'Status' ), 'align' => 'left', 'width' => '80px', 'index' => 'is_active', 'renderer' => 'TBT_Rewards_Block_Manage_Special_Renderer_Active', 'type' => 'options', 'options' => array (1 => 'Active', 0 => 'Inactive' ) ) );
