...
/**
 * Metrics Collection Helper for Pie Chart Abstraction
 *
 * @category   TBT
 * @package    TBT_Reports
 * @author     Sweet Tooth Inc. <support@sweettoothrewards.com>
 */
abstract class TBT_Reports_Helper_Adminhtml_Metrics_Chart_Abstract
    extends Mage_Core_Helper_Abstract
{
     ...
     *
     * @return TBT_Reports_Helper_Adminhtml_Metrics_Chart_Abstract
     */
    ...
    protected function _getStoreIds()
    {
        ...
        $allowedStoreIds = array_keys(Mage::app()->getStores(true));
