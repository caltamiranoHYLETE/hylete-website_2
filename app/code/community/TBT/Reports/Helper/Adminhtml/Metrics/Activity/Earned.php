...
/**
 * Metrics Collection Helper for Points Activity Earnings
 *
 * @category   TBT
 * @package    TBT_Reports
 * @author     Sweet Tooth Inc. <support@sweettoothrewards.com>
 */
class TBT_Reports_Helper_Adminhtml_Metrics_Activity_Earned
    extends Mage_Adminhtml_Helper_Dashboard_Abstract
{
    ...
    protected function _initCollection()
    {
        ...
        $this->_collection = Mage::getResourceModel('rewards/transfer_collection')
            ->prepareMetricsPointsActivity($range, 'earn');
    }
    ...
    public function getTotalBeforePeriod()
    {
        ...
        $this->_totalBeforePeriod = Mage::getResourceModel('rewards/transfer_collection')
            ->getTotalPointsActivityBeforePeriod($range, 'earn');
