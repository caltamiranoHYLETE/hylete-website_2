    ...
    extends TBT_Reports_Block_Adminhtml_Dashboard_MetricsArea_Graph
{
    ...
    public function _construct()
    {
        ...
        $metricInfo = $this->__("This shows the number of customers who have placed more than one order.");
    ...
    {
        $this->setDataHelperName('tbtreports/adminhtml_metrics_orders_repeatPurchase');
