...
/**
 * Referral Social Buttons
 *
 * @category   TBT
 * @package    TBT_RewardsSocial2
 * @author     Sweet Tooth Inc. <support@sweettoothrewards.com>
 */
class TBT_RewardsSocial2_Model_System_Config_Source_Refer
{
    const FACEBOOK_SHARE = 1;
    const TWITTER_TWEET = 2;

    /**
     * Retrieve Referring Social Buttons Option array
     * @return array
     */
