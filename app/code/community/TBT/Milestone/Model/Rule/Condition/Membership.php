...
/**
 * Membership Rule Condition Model
 *
 * @category   TBT
...
class TBT_Milestone_Model_Rule_Condition_Membership extends TBT_Milestone_Model_Rule_Condition
{
    ...
    {
        return Mage::helper('rewards/transfer_reason')->getReasonId('milestone_membership');
    }
    ...
    /**
     * Validate Save
     * @return \TBT_Milestone_Model_Rule_Condition_Membership
     * @throws Exception
     */
