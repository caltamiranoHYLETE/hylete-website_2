...
class TBT_RewardsReferral_Model_Observer_Adminhtml_Block_Output extends Varien_Object
{
    /**
     * Executed from the core_block_abstract_to_html_after event
     * Method used for admin integration only
     * @see Event: `core_block_abstract_to_html_after` Observer: `tbt_rewardsref_model_observer_block_output`
