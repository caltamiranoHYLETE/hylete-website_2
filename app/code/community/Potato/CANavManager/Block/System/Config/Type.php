...
class Potato_CANavManager_Block_System_Config_Type extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        return $element
            ->setRenderer(Mage::getBlockSingleton('po_canm/system_config_renderer_links'))
            ->getHtml();
    }
