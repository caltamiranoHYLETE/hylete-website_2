...
class Cryozonic_StripeExpress_Helper_Data extends Mage_Payment_Helper_Data
{
    /**
     * Get Stripe Model
     * @return Cryozonic_Stripe_Model_Standard
     */
    public function getStripe()
    {
        $stripe = Mage::getModel('cryozonic_stripe/standard');
        $stripe->addOn(Cryozonic_StripeExpress_Model_Config::ADDON_NAME, Cryozonic_StripeExpress_Model_Config::ADDON_VERSION);
        return $stripe;
    }
    ...
    {
        $cents = ($this->getStripe()->isZeroDecimal($currency) ? 1 : 100);
    ...
    {
        return $this->getStripe()->getAdminOrderGuestEmail();
    }
    ...
    {
        $active = Mage::getStoreConfig('payment/cryozonic_stripe/active');
        $activeLocation = Mage::getStoreConfig('payment/cryozonic_stripeexpress/' . $location);
