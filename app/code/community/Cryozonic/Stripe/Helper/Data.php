...
class Cryozonic_Stripe_Helper_Data extends Mage_Payment_Helper_Data
{
    ...
    public function initStripe()
    {
        ...
        \Stripe\Stripe::setAppInfo(Cryozonic_Stripe_Model_Standard::MODULE_NAME, Cryozonic_Stripe_Model_Standard::MODULE_VERSION, Cryozonic_Stripe_Model_Standard::MODULE_URL);
