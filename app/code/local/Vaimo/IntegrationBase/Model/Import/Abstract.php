...
abstract class Vaimo_IntegrationBase_Model_Import_Abstract extends Varien_Object
{
    protected $_type;
    ...
    final public function import($limit = 0, $operationId = 0)
    {
        ...
        Mage::dispatchEvent('integrationbase_import_' . $this->_eventPrefix . '_complete', array('result' => $result));
