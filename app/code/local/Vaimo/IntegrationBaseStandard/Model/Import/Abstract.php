...
abstract class Vaimo_IntegrationBaseStandard_Model_Import_Abstract extends Mage_Core_Model_Abstract
{
    protected $_logFile = 'standard_import.log';
    protected $_read = null;
    protected $_write = null;
    protected $_tableNames = array();
    protected $_successCount = 0;
    protected $_failureCount = 0;
    protected $_successMessage = '%d record(s) imported';
    protected $_failureMessage = '%d record(s) failed to import';
