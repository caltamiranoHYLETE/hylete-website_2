 ...
 * @comment     This is an exact copy of the Mage_Core_Model_Factory. Using it here to allow backwards compatibility with older Magento versions and allow more flexible testing.
 */

class Vaimo_Menu_Model_Core_Factory
{
    /**
