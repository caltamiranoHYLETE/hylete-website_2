...
class Vaimo_Menu_Test_Block_Navigation_Type_SimpleDropDwonTest extends Vaimo_Menu_Test_Block_Navigation_Type_BaseCase
{
    protected $_model;
    ...
    public function setUp()
    {
        ...
        $this->_model = new Vaimo_Menu_Block_Navigation_Type_SimpleDropDown();
    ...
    public function testRenderMenuReturnsMenuStructureInExpectedFormat()
    {
