...
class Vaimo_Menu_Block_Navigation_Type_SimpleNestedDropDown extends Vaimo_Menu_Block_Navigation_Type_Breakpoints
{
    protected $_typeClasses = array('menu-simple-nested-dropdown', 'menu-columns');
