...
class Vaimo_Menu_Block_Navigation_Type_SimpleDropDownColumns extends Vaimo_Menu_Block_Navigation_Type_Breakpoints
{
    protected $_typeClasses = array('menu-simple-dropdown', 'menu-columns');
