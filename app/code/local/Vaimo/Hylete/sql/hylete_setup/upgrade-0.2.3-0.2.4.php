...
//Create Ship Date Text attribute
$catalogSetup->addAttribute(Mage_Catalog_Model_Product::ENTITY, 'ship_date_text', array(
    'label' => 'Ship Date Text',
    'note' => 'Text to be displayed when a Back It product has a ship date',
...
$attribute = $catalogSetup->getAttribute('catalog_product', 'ship_date_text');
