...
class Vaimo_CmsProduct_Model_Attribute_Source_Cms extends Mage_Eav_Model_Entity_Attribute_Source_Abstract
{
    protected $_options;
    ...
    public function getAllOptions()
    {
        if (!$this->_options) {
            $collectionArray = Mage::getResourceModel('cms/block_collection')
                ->addFieldToFilter('identifier', array('like' => 'cms_product_%'))
                ->toArray();
