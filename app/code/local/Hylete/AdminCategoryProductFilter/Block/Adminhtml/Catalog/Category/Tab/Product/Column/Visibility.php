...
/**
 * Render visibility column
 */
class Hylete_AdminCategoryProductFilter_Block_Adminhtml_Catalog_Category_Tab_Product_Column_Visibility
    extends Hylete_AdminCategoryProductFilter_Block_Adminhtml_Catalog_Category_Tab_Product_Product
{
    ...
    {
        return $this->_render($row, 'visibility');
    }
}
