...
class Itoris_Installer_Client{
	 ...
	 * @return bool
	 */
	public static function isRegistered($alias, Mage_Core_Model_Website $website = null){return true;
	 ...
	 * @return bool
	 */
	public static function isRegisteredAutonomous($alias, Mage_Core_Model_Website $website = null){return true;
	 ...
	 * @return bool
	 */
	public static function isAdminRegistered($alias){return true;
		$collection = self::prepareStoresCollectionForAdmin();
		$hosts = self::getHostsList($collection);
		self::cleanLicenses($alias, $hosts);
		return self::isAnyLicenseExists($alias, $hosts);
	 ...
	 * @return bool
	 */
	public static function isAdminRegisteredAutonomous($alias){return true;
		$collection = self::prepareStoresCollectionForAdmin();
		$hosts = self::getHostsList($collection);
		return self::isAnyLicenseExists($alias, $hosts);
	}
