...
class Mage_SalesRule_Model_Validator extends Mage_Core_Model_Abstract
{
	...
	/**
	 * MYLES: This is the only function modified in this overwritten core class.
	 *
	 * The modifications check to see if the 'price_selector' attribute (provided by Amasty_Rules) on a basic, core,
	 * and default SalesRule has been set to "2" – which is the "target original price, not special price" enumeration.
	 *
