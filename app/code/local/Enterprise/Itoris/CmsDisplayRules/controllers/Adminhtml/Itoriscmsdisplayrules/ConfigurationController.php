...
class Itoris_CmsDisplayRules_Adminhtml_Itoriscmsdisplayrules_ConfigurationController extends Itoris_CmsDisplayRules_Controller_Admin_Controller {
	...
	public function saveAction() {
        ...
        try{
            Mage::getModel('itoris_cmsdisplayrules/settings')->save($settings, $scopeData['scope'], $scopeData['scope_id']);
