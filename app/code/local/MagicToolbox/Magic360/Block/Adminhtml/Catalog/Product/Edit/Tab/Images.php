...
class MagicToolbox_Magic360_Block_Adminhtml_Catalog_Product_Edit_Tab_Images extends Mage_Adminhtml_Block_Widget_Form implements Mage_Adminhtml_Block_Widget_Tab_Interface {
    ...
    protected function _prepareForm() {
        ...
        $fieldset = $form->addFieldset('group_fields_magic360_images', array('legend' => Mage::helper('magic360')->__('Images'), 'class' => 'magic360-fieldset'));
        $multiRows = false;
        $columnsNumber = 0;
        $rowsNumber = 1;
        $imagesCount = 0;
        ...
        $id = intval($id);//NOTE: fixed an issue with SQL query when $id is empty
        ...
        $fieldset->addField('magic360_gallery', 'magic360_gallery', array(
            'label'     => Mage::helper('magic360')->__('Magic360 gallery'),
