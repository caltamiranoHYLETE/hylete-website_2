...
<script type="text/javascript">
    ...
    var fieldsets = getElementsByClass("magic360-fieldset");
    var header = null;
    var buttons = null;
    ...
    for(var i = 0; i < magictoolboxOptionsLength; i++) {
        ...
        var idMatch = optionName.match(/^magic360\[([^\[]+)\]\[([^\[]+)\]\[([^\[]+)\]/i);
            ...
            if(idMatch[2] == "default") {
                ...
                magictoolboxOptions[i].onchange = function() {
                    ...
                    for(var profile in magictoolboxPofiles) {
                        var elements = document.getElementsByName("magic360["+thisPlatform+"]["+profile+"]["+thisId+"]");
                        if(elements.length) {
                            if((elements[0].tagName.toLowerCase() == "select" || elements[0].getAttribute("type") == "text") &&
                                ...
                                var radios = document.getElementsByName("magic360["+thisPlatform+"][default]["+thisId+"]");
                                var defaultValue = "";
                                var j;
