...
class MagicToolbox_Magic360_Block_Adminhtml_Settings_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $elementRenderer = $this->getLayout()->createBlock('magic360/adminhtml_settings_edit_tab_form_renderer_fieldset_element');
        $fieldsetRenderer = $this->getLayout()->createBlock('magic360/adminhtml_settings_edit_tab_form_renderer_fieldset');
        ...
        foreach($helper->getParamsMap($blockId) as $group => $ids) {
            $fieldset = $form->addFieldset(
                ...
                array(
                    'legend' => Mage::helper('magic360')->__($group),
                    'class' => 'magic360-fieldset'
                )
            );
            ...
            foreach($ids as $id) {
                $config = array(
                    ...
                    'name'      => 'magic360[desktop]['.$blockId.']['.$id.']',
                    'note'      => '',
