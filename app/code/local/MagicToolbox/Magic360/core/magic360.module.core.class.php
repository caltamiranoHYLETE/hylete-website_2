...
if(!defined('Magic360ModuleCoreClassLoaded')) {
    ...
    class Magic360ModuleCoreClass {
        ...
        function getHeadersTemplate($jsPath = '', $cssPath = null) {
            ...
            $headers = array();
            // add module version
            $headers[] = '<!-- Magic 360 Magento module version v4.14.6 [v1.6.46:v4.6.6] -->';
        ...
        function loadDefaults() {
            $params = array(
				"enable-effect"=>array("id"=>"enable-effect","group"=>"General","order"=>"10","default"=>"Yes","label"=>"Enable Magic 360™","type"=>"array","subType"=>"select","values"=>array("Yes","No"),"scope"=>"module"),
				...
				"icon"=>array("id"=>"icon","group"=>"Miscellaneous","order"=>"10","default"=>"media/magictoolbox/magic360/360icon.jpg","label"=>"Icon for thumbnail","description"=>"Relative for site base path.","type"=>"text","scope"=>"module"),
