...
class MagicToolbox_Magic360_Magic360Controller extends Mage_Adminhtml_Controller_Action {
    ...
    public function addAction() {
        ...
        if($data = $this->getRequest()->getPost()) {
            ...
            if(empty($oldModulesInstalled)) {
                $defaultValues = Mage::helper('magic360/params')->getDefaultValues();
            } else {
                $defaultValues = Mage::helper('magic360/params')->getFixedDefaultValues();
            }
        ...
        if($model->getId()) {
            ...
            if(!empty($oldModulesInstalled)) {
                $message = 'You have installed '.
                    ...
                    'Pease update it to the latest version to work correctly with this version of the Magic 360 module.';
                Mage::getSingleton('adminhtml/session')->addError(Mage::helper('magic360')->__($message));
            }
    ...
    protected function _isAllowed() {
        return Mage::getSingleton('admin/session')->isAllowed('admin/magictoolbox/magic360');
    }
