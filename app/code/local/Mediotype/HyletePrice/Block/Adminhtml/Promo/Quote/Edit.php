 ...
 */
class Mediotype_HyletePrice_Block_Adminhtml_Promo_Quote_Edit extends Amasty_Rules_Block_Adminhtml_Promo_Quote_Edit
{
    public function __construct()
    {
        ...
        // MYLES: _formScripts is set in the constructor of this class's parent, so clear it before adding.
        $this->_formScripts = [];
