...
class Icommerce_EmailAttachments_Adminhtml_EmailAttachments_OrderController extends Mage_Adminhtml_Sales_OrderController
{
        ...
        if (!empty($orderIds)) {
            foreach ($orderIds as $orderId) {
                ...
                if (!isset($pdf)){
                    ...
                    $pages = Mage::getModel('emailattachments/order_pdf_order')->getPdf(array($order));
