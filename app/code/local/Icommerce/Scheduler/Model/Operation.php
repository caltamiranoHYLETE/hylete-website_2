...
class Icommerce_Scheduler_Model_Operation extends Mage_Core_Model_Abstract
{
    ...
    protected function _beforeSave()
    {
        ...
        if ($this->getStatus() == Icommerce_Scheduler_Helper_Data::OPERATION_STATUS_ENABLED && !$this->getMasterId()) {
    ...
    {
        $lastRun = Mage::getModel('scheduler/operation')->load($this->getId())->getLastRun();
