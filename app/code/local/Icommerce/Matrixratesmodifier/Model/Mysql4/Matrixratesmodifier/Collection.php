 ...
 *
 * @category    Icommerce
 * @package     Icommerce_Places
 * @copyright   Copyright (c) 2009-2011 Icommerce Nordic AB
 */
class Icommerce_Matrixratesmodifier_Model_Mysql4_Matrixratesmodifier_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
