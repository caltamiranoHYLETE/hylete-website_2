 ...
 */
class Icommerce_Matrixratesmodifier_Block_Adminhtml_Matrixratesmodifier extends Mage_Adminhtml_Block_Widget_Grid_Container
{
	public function __construct()
    {
        $this->_controller = 'adminhtml_matrixratesmodifier';
        $this->_blockGroup = 'matrixratesmodifier';
        $this->_headerText = Mage::helper('matrixratesmodifier')->__('Manage Shipping Rates');
        $this->_addButtonLabel = Mage::helper('matrixratesmodifier')->__('Add');
        parent::__construct();
    }
}