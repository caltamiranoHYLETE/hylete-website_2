...
class Icommerce_CatalogImageFormat_Model_Config_Source_Imageprocessor
{
    ...
    {
        return array(
            array('value' => Varien_Image_Adapter::ADAPTER_GD2, 'label' => 'GD2'),
            array('value' => Varien_Image_Adapter::ADAPTER_IM, 'label' => 'Imagick'),
        );
    }
}
