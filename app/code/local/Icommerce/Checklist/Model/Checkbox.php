...
class Icommerce_Checklist_Model_Checkbox
{
    function getCheckboxes($listshowId)
    {
    ...
    {
        $row = Icommerce_Db::getRow("SELECT * FROM icommerce_checklist_item_checkbox WHERE id = ?", $itemId);
        return $row;
    }
    ...
    */
    ...
    function getListshowCheckbox($listshowId)
    {
        ...
        $sql = "";
        $sql .= "SELECT si.* ";
        $sql .= "FROM icommerce_checklist_item_checkbox AS si ";
        $sql .= "INNER JOIN icommerce_checklist_item_checkbox as s ";
