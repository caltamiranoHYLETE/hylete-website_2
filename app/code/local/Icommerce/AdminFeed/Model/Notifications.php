...
class Icommerce_AdminFeed_Model_Notifications
{
	public function getNotifications()
	{
		$r = Icommerce_Db::getDbRead();
        $rows = $r->query( "SELECT * FROM adminnotification_inbox WHERE is_remove='0' ORDER BY notification_id DESC" );
	...
	{
		if(Icommerce_Db::getDbSingleton("SELECT is_read FROM adminnotification_inbox WHERE notification_id='$id'"))
			return true;
		else
			return false;
	}
