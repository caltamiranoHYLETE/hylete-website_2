...
class Icommerce_AdminFeed_Adminhtml_TicketsController extends Mage_Adminhtml_Controller_Action
{
    protected function _isAllowed()
    {
        return Mage::getSingleton('admin/session')->isAllowed('icommerce/tickets');
    }
