...
class Icommerce_SlideshowManager_Block_Slideshow_Item_Editproduct extends Mage_Adminhtml_Block_Widget_Container
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->_addButton('product_save', array(
            'label' => Mage::helper('slideshowmanager')->__('Save'),
            'onclick' => 'editproductForm.submit()',
            'class' => 'save'
        ));
    ...
    public function getForm()
    {
        return $this->getLayout()
            ->createBlock('slideshowmanager/slideshow_item_editproduct_form')
            ->toHtml();
    }
}
