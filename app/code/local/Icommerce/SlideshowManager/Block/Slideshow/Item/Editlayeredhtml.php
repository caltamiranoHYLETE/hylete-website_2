 ...
 */
class Icommerce_SlideshowManager_Block_Slideshow_Item_Editlayeredhtml extends Mage_Adminhtml_Block_Widget_Container
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->_addButton('editlayeredhtml_save', array(
            'label'   => Mage::helper('slideshowmanager')->__('Save'),
            'onclick' => 'editlayeredhtmlForm.submit()',
            'class'   => 'save'
        ));
    ...
    public function getForm()
    {
        return $this->getLayout()
            ->createBlock('slideshowmanager/slideshow_item_editlayeredhtml_form')
            ->toHtml();
    }
