 ...
 */
class Icommerce_SlideshowManager_Block_Slideshow_Item_Addproduct extends Mage_Adminhtml_Block_Widget_Container
{
    ...
    public function getForm()
    {
        return $this->getLayout()
            ->createBlock('slideshowmanager/slideshow_item_addproduct_form')
            ->toHtml();
    }
}
