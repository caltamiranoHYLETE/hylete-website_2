...
class Icommerce_PageManager_Block_Page_Row_Edit extends Mage_Adminhtml_Block_Widget_Container
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->_addButton('delete', array(
            ...
            'onclick'   => 'if(confirm(\''.Mage::helper('pagemanager')->__('Are you sure?').'\')){window.location.href=\''.$this->getUrl('*/pageitem/delete/id/'.$id).'\';}',
            'class'   => 'delete'
        ));
