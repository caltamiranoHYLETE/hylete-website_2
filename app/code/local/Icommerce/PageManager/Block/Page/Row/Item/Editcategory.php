 ...
 */
class Icommerce_PageManager_Block_Page_Row_Item_Editcategory extends Mage_Adminhtml_Block_Widget_Container
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->_addButton('delete', array(
            ...
            'onclick'   => 'if(confirm(\''.Mage::helper('pagemanager')->__('Are you sure?').'\')){window.location.href=\''.$this->getUrl('*/pageitem/deletecategory/id/'.$id).'\';}',
            'class'   => 'delete'
        ));
