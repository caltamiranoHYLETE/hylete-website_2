...
try {
    /** @var Vaimo_FjrIntegration_Model_Import_Stock $import */
    $import = Mage::getModel('integrationbasestandard/import_stock');
    $importPath = Mage::getBaseDir('var') . DS . 'import' . DS . 'standard' . DS . 'stock' . DS;
