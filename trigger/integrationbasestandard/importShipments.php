...
try {
    /** @var Vaimo_IntegrationBaseStandard_Model_Import_Shipments $import */
    $import = Mage::getModel('integrationbasestandard/import_shipments');
    $importPath = Mage::getBaseDir('var') . DS . 'import' . DS . 'standard' . DS . 'shipments' . DS;
