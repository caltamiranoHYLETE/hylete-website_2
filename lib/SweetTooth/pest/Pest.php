...
require_once 'exceptions/PestException.php';
require_once 'exceptions/PestClientError.php';
require_once 'exceptions/PestBadRequest.php';
require_once 'exceptions/PestConflict.php';
require_once 'exceptions/PestForbidden.php';
require_once 'exceptions/PestGone.php';
require_once 'exceptions/PestInvalidRecord.php';
require_once 'exceptions/PestMethodNotAllowed.php';
require_once 'exceptions/PestNotFound.php';
require_once 'exceptions/PestServerError.php';
require_once 'exceptions/PestUnauthorized.php';
require_once 'exceptions/PestUnknownResponse.php';
