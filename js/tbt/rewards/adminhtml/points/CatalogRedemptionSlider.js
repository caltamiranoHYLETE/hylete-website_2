...
var CatalogRedemptionSlider = Class.create({
    /**
    * Constructor
    ...
    */
    initialize: function(sliderHandleId, sliderRailId, sliderCaptionId, sliderValueboxId) {
        ...
        this.updateCallbackNamespace = null;
    ...
    update: function(val) {
        ...
        this.updateCallback.apply(this.updateCallbackNamespace, this.updateCallback);
    },
    
    setUpdateCallback: function(classNamespace, callback) {
        this.updateCallback = callback;
        this.updateCallbackNamespace = classNamespace;
    },
    ...
    getPointsValue: function() {
        return this.getValue() * this.points_per_use;
    },
    ...
    getRealMaxUses: function(max_uses, points_per_use, cp, pp, pp_disp) {
        ...
        max_pp_uses = parseInt(max_pp_uses) + ((pp - parseInt(max_pp_uses) * pp_disp).toFixed(2) >= Math.pow(10,-2) ? 1 : 0 );
